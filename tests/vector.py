...
VECTOR_TESTS = [
    ("vector.to()", test_vector_to),
    ("vector.to() diagonal", test_vector_to_diagonal),
    ("vector.add()", test_vector_add),
    ("vector.to().over()", test_vector_to_over),
    ("vector.add().over() opposite", test_vector_add_opposite_over),
    ("layer().vector.offset.add()", test_layer_vector_offset_add),
