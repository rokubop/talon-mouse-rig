...
rig scroll go up: user.mouse_rig_scroll_go("up", 0.1)
rig scroll go down: user.mouse_rig_scroll_go("down", 0.1)
rig scroll go left: user.mouse_rig_scroll_go("left", 0.1)
rig scroll go right: user.mouse_rig_scroll_go("right", 0.1)
