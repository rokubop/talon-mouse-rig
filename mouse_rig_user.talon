...
rig turn left: user.mouse_rig_direction_to(-1, 0, 1000)
rig turn right: user.mouse_rig_direction_to(1, 0, 1000)
rig turn up: user.mouse_rig_direction_to(0, -1, 1000)
rig turn down: user.mouse_rig_direction_to(0, 1, 1000)
rig turn around: user.mouse_rig_direction_by(180, 1000)
